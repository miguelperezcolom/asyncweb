package com.example.backendsocket.socketio;
...
public class SocketIOController {
    ...
    public DataListener<Message> onSendMessage = new DataListener<Message>() {
        ...
        public void onData(SocketIOClient client, Message message, AckRequest acknowledge) throws Exception {
            ...
            log.info(message.getAuthor()+" user send message to user ? and message is "+message.getMessage());
            //socketServer.getBroadcastOperations().sendEvent(message.getAuthor(),client, message);
